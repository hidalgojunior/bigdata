    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-9">
                ...
                ?>
                <h1 class="text-center mb-4"><strong>ALTERAÇÃO DO USUÁRIO: <span style="color:red"><?=$dados['nome']?></span></strong></h1>
                <div class="container">
                    <div class="row">
                        <div class="container bg-">
                            <div class="row">
                                <div class="col-12">
                                    <form method="post" class="form-control" action="altera.php">
                                        <div class="row mt-2">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-sm-6 col-md-6 offset-6 offset-md-6">
                                                <button type="submit" class="btn btn-outline-primary form-control" name="acao" id="acao">Alterar Dados do Usuário</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
